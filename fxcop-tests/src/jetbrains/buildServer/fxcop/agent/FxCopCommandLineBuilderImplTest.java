...
public class FxCopCommandLineBuilderImplTest extends BaseTestCase {
  ...
  public void testWhatNoProject() throws Exception {
    ...
    assertCmdLine("[C:\\myroot\\FxCopCmd.exe] [/out:" + FxCopConstants.OUTPUT_FILE + "] ");
  }
  ...
  public void testWhatProject() throws Exception {
    ...
    assertCmdLine("[C:\\myroot\\FxCopCmd.exe] [/project:someproject] [/out:" + FxCopConstants.OUTPUT_FILE + "] ");
  }
  ...
  public void testWhatFiles() throws Exception {
    ...
    assertCmdLine("[C:\\myroot\\FxCopCmd.exe] [/f:file1*.dll] [/f:file2] [/out:" + FxCopConstants.OUTPUT_FILE + "] ");
  }
  ...
  public void testAddonOptions() throws Exception {
    ...
    assertCmdLine("[C:\\myroot\\FxCopCmd.exe] [bla-bla] [qqq] [/out:" + FxCopConstants.OUTPUT_FILE + "] ");
  }
}
